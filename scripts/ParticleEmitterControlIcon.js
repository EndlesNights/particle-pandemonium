/**
 * A helper for drawing a particleEmitter Control Icon
 * @type {PIXI.Container}
 */
export class ParticleEmitterControlIcon extends PIXI.Container {
    constructor({ texture, size = 40, borderColor = 0xFF5500, tint = null, elevation = 0 } = {}, ...args) {
        ...
        // add offset
        this.x -= this.width * 0.435;
        this.y -= this.height * 0.435;
